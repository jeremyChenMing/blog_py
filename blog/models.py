...
#
#     def create_user(self, nickname, username, password=None, dep=0):
#         if not username:
#             raise ValueError("Users must have an email address")
#         user = self.model(username=nickname, email=username)
#         user.save(using=self._db)
#         return user
#
#     def create_superuser(self, nickname, username, password):
#         user = self.create_user(email=username, username=nickname, password=password)
